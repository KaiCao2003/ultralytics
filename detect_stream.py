...
base_dir = "/mnt/senzailab/Kai/#Recording/m20"
date = 260918

video_path = f"{base_dir}/{date}/{date}_2/{date}.avi"
...
csv_path, position_path, json_path, output_path = [str(local_dir / path.name) for path in remote_paths]
